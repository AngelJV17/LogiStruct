...
/**
 * Gestiona la carga y previsualización del logo corporativo
 */
...
watch(() => props.show, (val) => {
    if (val) {
        ...
        photoPreview.value = null; // Limpiar preview al cerrar
    }
});
</script>
                                ...
                                <div class="flex-1 grid grid-cols-1 gap-4">
                                    <div>
                                        ...
                                        <TextInput id="name" v-model="form.name" type="text"
                                            class="mt-1 block w-full bg-gray-50/30 focus:bg-white font-bold uppercase text-sm"
                                            placeholder="EJ: CORPORACIÓN INMOBILIARIA S.A.C" required />
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                <div>
                                    ...
                                    <TextInput id="address" v-model="form.address" type="text"
                                        class="mt-1 block w-full bg-gray-50/30 uppercase text-xs"
